...
export const GroupsProvider = ({ children }) => {
  ...
  // FIXED: Enhanced fetchGroups with proper guard logic
  const fetchGroups = useCallback(async (category = 'All') => {
    // Only prevent if EXACT same request is in progress
  ...
  }, [token, user]); // ✅ FIXED: No groups dependency
  ...
  const addMessage = useCallback(async (groupId, messageData) => {
